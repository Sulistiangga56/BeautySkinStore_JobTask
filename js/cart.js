...
if (isLogin) {
  ...
  function displayCart(data) {
    ...
    data.forEach(function (el, index) {
      ...
      if (el.price != 0) {
        ...
        td4.innerText = "Rp " + el.price * el.quantity + ".000";
      } else {
        td2.innerText = " ";
        td3.innerText = " ";
  ...
  function totalPrice(data) {
    ...
    price.innerText = "Rp " + total_price + ".000";
  ...
  function couponSubmited(event) {
    event.preventDefault();
    let saving = document.querySelector("#NASsavings");
    let b = document.createElement("b");
    b.innerText = "-Rp " + total_price * 0.3;
    ...
    if (input_value == "Masai30" || input_value == "masai30") {
      localStorage.setItem("Prscoupan", JSON.stringify(true));
      saving.append("30% is off on Every Product", b);
    }
  }

  document
    .querySelector("#NASgifts-click")
    .addEventListener("click", collapseGifts);
  ...
  function collapseGifts() {
    ...
    if (display == "none") {
      ...
      document
        .querySelector("#NASgifts-click")
        .children[0].setAttribute("class", "fa fa-angle-down");
    } else {
      ...
      document
        .querySelector("#NASgifts-click")
        .children[0].setAttribute("class", "fa fa-angle-up");
    }
  }
  ...
  function totalPrice_freeDelivery() {
    ...
    if (total_price < 250) {
      ...
      img.setAttribute(
        "src",
        "https://www.citypng.com/public/uploads/preview/blue-and-white-round-flat-bell-icon-free-png-11638983856xnczcwyace.png"
      );
      let span = document.createElement("span");
      span.innerText = `Spend another ${
        250 - total_price + ".000"
      } and receive FREE US tracked delivery!`;
      div.append(img, span);
  ...
  function totalPrice_gifts() {
    if (total_price >= 130000) {
      ...
      img.setAttribute(
        "src",
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqCf-8YnNG8UbVsxsEdNRyD1DQrcQM4SgzxEZtnFw0rVoKnm285FpR_z6WAbayEOdYm4o&usqp=CAU"
      );
      let p = document.createElement("p");
      p.innerText =
        "You have qualified for: Select a gift for you or someone you love when you spend Rp 130.000 or more Don't forget to make your selection below";
  ...
  function gifts_qualification() {
    ...
    if (total_price < 130) {
      let div = document.createElement("div");
      let p = document.createElement("p");
      p.innerText = "Spend Rp 130.000 or more to qualify";
      let p1 = document.createElement("p");
      p1.innerText = `${130 - total_price + ".000"} to go`;
      ...
      img.setAttribute(
        "src",
        "https://as1.ftcdn.net/v2/jpg/03/66/39/06/1000_F_366390643_7nFXBxGB1YUHOdhNAxOkEJoovjNUWYLU.jpg"
      );
      ...
      div2.style.width = `${Math.floor((total_price / 130000) * 100)}%`;
